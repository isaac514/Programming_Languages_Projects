...
program : statementList TOKEN_ENDPROG
		{ 	
			return 0;
		}
		;
...
statement	: TOKEN_ID TOKEN_ASSIGN expr
		{
			
			//lookup variable in symbol table
			pair = lookup(&symtab , $1);

			if (pair == NULL)
			{
				//Create new entry and insert expression value
				pair = insert(&symtab , $1 , expr_evaluate($3));
